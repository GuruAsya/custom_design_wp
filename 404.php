                ...
                <div class="col-md-6 col-md-offset-3 text-center">
                    <div class="error-page">
                        ...
                        <div class="search-form">
                            <form action="<?php bloginfo('template_directory') ?>/404.php">
                                <input type="search" placeholder="Type to search here">
                                <button type="submit"><i class="fa fa-search"></i></button>
                            </form>
                        </div>
                        
                        <a href="<?php bloginfo('template_directory') ?>/index.php" class="readmore-btn"><i class="fa fa-angle-left"></i> Back to homepage</a>
                    </div>
                </div>
            </div>
        </div>
